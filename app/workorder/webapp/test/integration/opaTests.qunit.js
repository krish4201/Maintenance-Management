...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "maintenance/workorder/workorder/test/integration/FirstJourney",
    "maintenance/workorder/workorder/test/integration/WorkOrdersListJourney",
    "maintenance/workorder/workorder/test/integration/WorkOrdersObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
