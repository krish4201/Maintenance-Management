...
sap.ui.require(
  [
    ...
    "sap/ui/qunit/qunit-junit",
    "sap/ui/qunit/qunit-coverage",
    "maintenance/equipment/equipment/test/integration/FirstJourney",
    "maintenance/equipment/equipment/test/integration/EquipmentsListJourney",
    "maintenance/equipment/equipment/test/integration/EquipmentsObjectPageJourney",
], function (QUnit) {
    "use strict";
    QUnit.start();
});
